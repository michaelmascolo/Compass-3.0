...
import { Compass, Target, PencilLine, Users, ArrowUpRight, RotateCcw } from "lucide-react";
...
export default function ExperienceReflection({ reflection, draft, onRestart }) {
  const r = reflection || {};
  return (
    <motion.div
