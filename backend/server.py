...
5. Determine the functional RELATIONSHIPS among those elements (use these to inform your judgment; they are canonical KB facts supplied downstream, so you do NOT output them).
