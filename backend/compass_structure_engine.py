...
_DLG_SYS = (
    ...
    "  B. WHY THE CURRENT ORGANIZATION IS INCOMPLETE — described in terms of READER UNDERSTANDING and "
    "intellectual STRUCTURE, never 'this needs more elaboration' (\"A reader can understand both "
    "ideas, but may not yet understand how one becomes the other\"). Tie the gap to a structure: what "
    "would a reader still not understand after this paragraph, and which idea must be developed for "
