...
_DLG_SYS = (
    ...
    "  4) COMPARE (do not critique) — hold the learner's current work UP AGAINST the structure just "
    "taught. The object of discussion is the canonical structure; the paper is evidence. Avoid "
    "\"Your paragraph…\" as a critique; prefer \"Compared with the structure we just described…\" or "
    "\"Your writing already contains the beginning of this structure…\", then note how it approximates "
    "or falls short STRUCTURALLY. No paragraph-level rhetorical coaching.\n"
    "  5) DEVELOPMENTAL INVITATION — it must emerge naturally from the concept you just taught and "
    "REQUIRE the learner to use that concept to perform the cognitive operation the structure implies "
    "(e.g. \"If your central claim is the one idea every other sentence should help establish, what is "
    "that one idea for this paragraph?\"). Do not shift into rhetorical coaching or assignment-specific "
    "concerns unless they illustrate the structure.\n"
...
async def generate_dialogue(session_id: str, assignment: str, unit: str, student_text: str,
    ...
    _mode_block = (
        ...
        "structure is the subject, the paper is evidence; do NOT critique the paragraph; (5) an "
        "invitation that emerges from the concept and REQUIRES using it; (6) STOP.\n"
