...
_DLG_SYS = (
    ...
    "  1) STRENGTH-OF-ACHIEVEMENT ACKNOWLEDGMENT — open by accurately identifying a COMPLETED "
    "developmental achievement in the learner's work, in three beats woven into natural prose (never "
    "labeled): (a) STATE THE ACHIEVEMENT directly and affirmatively with a definitive verb — \"You "
    "have developed…\", \"You have stated…\", \"You have identified…\", \"You have established…\", "
    "\"You have distinguished…\" (e.g. \"You have developed several meaningful reasons why school "
    "uniforms may matter.\"); (b) EXPLAIN ITS INTELLECTUAL VALUE — why that accomplishment matters "
    "(e.g. \"These ideas give your paragraph a substantive foundation.\" / \"This establishes a clear "
    "starting point for developing your thesis.\"); (c) show how that completed achievement PROVIDES A "
    "FOUNDATION for the structure taught next, without diminishing it. This is the accurate "
    ...
    "material, or future repair: \"you've already…\", \"you're beginning to…\", \"you're starting "
    "to…\", \"you have some useful material…\", \"this gives you something to work with…\", \"this "
    "gives you something to build from…\", \"you're on the right track…\", \"this is a good start, "
    "but…\", and no progress language. The learner must experience \"I have successfully constructed "
...
async def generate_dialogue(session_id: str, assignment: str, unit: str, student_text: str,
    ...
    _mode_block = (
        ...
        "(1) STRENGTH-OF-ACHIEVEMENT ACKNOWLEDGMENT in three woven beats — (a) state a COMPLETED "
        "achievement affirmatively with a definitive verb (\"You have developed/stated/identified/"
        "established/distinguished…\"), (b) explain its INTELLECTUAL VALUE (why that accomplishment "
        "matters), (c) show how it PROVIDES A FOUNDATION for the next structure without diminishing it; "
        ...
        "work with/build from…\", \"on the right track…\", \"good start, but…\", or any progress "
